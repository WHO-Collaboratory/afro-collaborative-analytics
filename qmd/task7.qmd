...
by {epiparameter}—discretising continuous distributions, turning parameters 
...
<a href="outputs/nowcast_estimates.rds" download class="btn btn-primary" target="_blank">Download nowcast estimates</a>

## Example Report

<a href="data/solutions/task7_solution.qmd" download class="btn btn-primary" target="_blank">Download solution file</a>
